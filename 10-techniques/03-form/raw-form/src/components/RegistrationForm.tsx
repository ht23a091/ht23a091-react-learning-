...
import { Box, Button, ButtonGroup, Checkbox, Code, FormLabel, Input ,Select } from '@chakra-ui/react';
...
const RegistrationForm: FC = () => {
    const [formData, ssetFormData ] = useState<FormData>({
        username: '',
        isAgreed: false,
    });
    ...
    const handleChange = (event: ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        ...
        const value =
            event.target.type === 'checkbox'
                ...
                : event.target.value;
            ssetFormData((state) => ({ ...state, [name]: value}));
    };
